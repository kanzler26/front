...
import {
  CoursesApiPayload,
  CoursesApiQueryParams
} from "~/plugins/api/courses/courses.type"

export class CoursesApi extends Api {
  ...
  public readonly route = "/employer/courses"
  ...
  create ( payload: CoursesApiPayload ): Promise<ApiResponse<CoursesApiPayload>> {
  ...
  read ( query?: CoursesApiQueryParams ) {
  ...
  update ( id: number, payload: CoursesApiPayload ) {
